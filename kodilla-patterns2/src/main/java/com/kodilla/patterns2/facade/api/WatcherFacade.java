...
public class WatcherFacade {
    ...
    public void logEvent(OrderDto theOrder, Long theUserId, Object object){
        LOGGER.info("Class: " + object.getClass().getName() + ", User: " + theUserId + ", Order: " +theOrder.getItems().toString());
    }

    @Around("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processOrder(..))")
    public Object measureProceedOrderTime(final ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        Object result;
        try {
