...
public class SettingsFileEngine {
    private static SettingsFileEngine settingsFileEngineInastance = null;
    ...
    public static SettingsFileEngine getInstance(){
        if (settingsFileEngineInastance == null) {
            synchronized (SettingsFileEngine.class) {
                if (settingsFileEngineInastance == null) {
                    settingsFileEngineInastance = new SettingsFileEngine();
                }
            }
        }
        return settingsFileEngineInastance;
    }
