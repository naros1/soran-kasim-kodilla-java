...
public class ForumTestSuite {
    ...
    public void testAddComment() {
        ...
        //When
        forumUser.addComments(thePost, "mrsmith", "Thank you for all good words!");

        //Then
        Assert.assertEquals(1, forumUser.getCommantsQuantity());
    }
    @Test
    ...
    public void testGetComment() {
        ...
        ForumComment theComment = new ForumComment(thePost, "Thank you for all good words!",
                "mrssmith");
        forumUser.addComments(thePost, theComment.getAuthor(),
    ...
    public void testRemoveComment() {
        ...
        //Then
        Assert.assertTrue(result);
        Assert.assertEquals(0, forumUser.getCommantsQuantity());
    }
