...
public class SupplierExtraFoodShop implements Supplier {
    ...
    public SupplierExtraFoodShop(final String name,final OrderService orderService,final InformationService informationService,final OrderRepository orderRepository) {
        this.name = name;
    ...
    public OrderDto process(OrderRequest orderRequest) {
        ...
        if(isOrdered) {
            ...
            System.out.println("Zamówiono w sklepie Extra Food Shop !!!");
