...
public class SupplierGlutenFreeShop implements Supplier {
    ...
    public SupplierGlutenFreeShop(final String name,final OrderService orderService,final InformationService informationService,final OrderRepository orderRepository) {
        this.name = name;
    ...
    public OrderDto process(OrderRequest orderRequest) {
        ...
        if(isOrdered) {
            ...
            System.out.println("Zamówiono w sklepie Gluten Free Shop !!!");
